...
1. [MacOS Homebrew Cask for Camunda Modeler](https://github.com/Homebrew/homebrew-cask/blob/master/Casks/camunda-modeler.rb) ⭐ 22,198 | 🐛 28 | 🌐 Ruby | 📅 2026-09-12 - `brew install camunda-modeler`
2. [BPMN to PNG/PDF](https://github.com/bpmn-io/bpmn-to-image) ⭐ 76 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-10 - Convert BPMN 2.0 diagrams to PDF documents or PNG files.
...
4. [DMN Check](https://github.com/red6/dmn-check) ⭐ 44 | 🐛 28 | 🌐 Java | 📅 2026-09-10 - A Maven plugin which performs various static analyses on Decision Model Notation (DMN) files to detect bugs.
...
8. <https://github.com/DigitalState/Camunda-Spock-Testing> ⭐ 10 | 🐛 15 | 🌐 Groovy | 📅 2018-08-07
9. <https://github.com/camunda-consulting/camunda-util-demo-data-generator> ⭐ 9 | 🐛 2 | 🌐 Java | 📅 2018-11-02
10. <https://github.com/StephenOTT/vertx-bpmn-model-doc-generator> ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2018-03-20
11. <https://forum.camunda.org/t/camunda-to-asciidoctor-documentation-generator/6580>  <https://github.com/GeekMustHave/Camunda-ADOC-Viewer>  <https://github.com/GeekMustHave/Camunda-ASCIIDoc-Generator>
12. Unit Testing Coverage

# Load Testing / Performance Testing

1. <https://github.com/camunda/camunda-bpm-platform/tree/master/qa/performance-tests-engine> ⚠️ Archived
...
1. Variable Encryption: <https://github.com/StephenOTT/camunda-data-encryption-rsa> ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-16
...
1. <https://github.com/camunda/camunda-bpm-graphql> ⭐ 112 | 🐛 10 | 🌐 Java | 📅 2024-10-03
2. <https://github.com/Loydl/camunda-graphql-tasklist> ⭐ 2 | 🐛 11 | 🌐 JavaScript | 📅 2026-01-10
3. <https://github.com/Loydl/camunda-graphql-client-example> ⭐ 1 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-10
4. <https://github.com/Loydl/camunda-graphql-client-example> ⭐ 1 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-10
5. GraphQL API: <https://forum.camunda.org/t/developing-the-camunda-graphql-extension/2872/35>
...
1. [Custom Batch](https://github.com/camunda/camunda-bpm-custom-batch) ⚠️ Archived - A plugin to provide a simple way of using the Camunda Batch functionality.
2. <https://github.com/DigitalState/camunda-administrative-user-plugin> ⭐ 8 | 🐛 0 | 🌐 Java | 📅 2018-03-02
3. Form JS Validation <https://github.com/StephenOTT/camunda-form-validator-js-server> ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-17
4. Vertx <https://github.com/StephenOTT/camunda-vertx-plugin> ⚠️ Archived
5. <https://github.com/StephenOTT/camunda-incident-handler-nashorn-js> ⭐ 4 | 🐛 1 | 🌐 Java | 📅 2018-04-30
6. JWT Provider: <https://github.com/Loydl/camunda-jwt-provider> ⭐ 3 | 🐛 25 | 🌐 Java | 📅 2025-08-17
...
1. <https://github.com/plexiti/camunda-grails-plugin> ⭐ 18 | 🐛 16 | 🌐 Groovy | 📅 2017-08-20 (Grails 2 only, Camunda 7.3.x)
...
2. [Vienna Camunda Meetup Group](http://www.meetup.com/camunda-vienna) - \[Github Organization]
