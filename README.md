...
1. [MacOS Homebrew Cask for Camunda Modeler](https://github.com/Homebrew/homebrew-cask/blob/master/Casks/camunda-modeler.rb) ⭐ 22,195 | 🐛 28 | 🌐 Ruby | 📅 2026-09-09 - `brew install camunda-modeler`
2. [BPMN to PNG/PDF](https://github.com/bpmn-io/bpmn-to-image) ⭐ 76 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-09 - Convert BPMN 2.0 diagrams to PDF documents or PNG files.
...
4. [DMN Check](https://github.com/red6/dmn-check) ⭐ 44 | 🐛 27 | 🌐 Java | 📅 2026-09-03 - A Maven plugin which performs various static analyses on Decision Model Notation (DMN) files to detect bugs.
