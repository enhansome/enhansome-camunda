...
1. [MacOS Homebrew Cask for Camunda Modeler](https://github.com/Homebrew/homebrew-cask/blob/master/Casks/camunda-modeler.rb) ⭐ 22,180 | 🐛 26 | 🌐 Ruby | 📅 2026-08-31 - `brew install camunda-modeler`
...
4. [DMN Check](https://github.com/red6/dmn-check) ⭐ 44 | 🐛 23 | 🌐 Java | 📅 2026-08-31 - A Maven plugin which performs various static analyses on Decision Model Notation (DMN) files to detect bugs.
